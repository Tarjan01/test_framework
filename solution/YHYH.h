 ...
 *
 * The YHYH object stores only the neighbor link structure, see
 * IndexYHYH.h for the full index object.
 */
...
struct SearchParametersYHYH : SearchParameters {
    int efSearch = 16;
    bool check_relative_distance = true;

    ~SearchParametersYHYH() {}
};
...
struct YHYH {
    ...
    YHYHStats search(
            ...
            ResultHandler<C>& res,
            VisitedTable& vt,
            const SearchParametersYHYH* params = nullptr) const;
...
struct YHYHStats {
    ...
    void combine(const YHYHStats& other) {
        n1 += other.n1;
        n2 += other.n2;
        n3 += other.n3;
        ndis += other.ndis;
...
FAISS_API extern YHYHStats yhyh_stats;
